module Eatabit
  module REST
    ##
    # The Eatabit::REST::Client class caches authentication parameters and
    ...
    # work with the more pleasant wrapper objects like Eatabit::REST::Call.
    #
    ...
    class Client
      ...
      HTTP_HEADERS = {
        ...
        'User-Agent' => "eatabit-rails/#{Eatabit::VERSION}",
      }
      ...
      # supported:
      #
      # === <tt>:host => 'api.eatabit.io'</tt>
      #
      # The domain to which you'd like the client to make HTTP requests. Useful
      # for testing. Defaults to 'api.eatabit.io'.
      #
      # === <tt>:port => 443</tt>
      #
      ...
      def connect_and_send(request) # :doc:
        ...
        begin
          ...
          if response.kind_of? Net::HTTPServerError
            raise Eatabit::REST::ServerError
          end
        rescue Exception
